...
#define GENERATE_TESTING_TYPES_ALL_OPTIONS(DSTTYPE, SRCTYPE, DIRECTION)                                       \
  FFTCallSpec<DSTTYPE, SRCTYPE, DIRECTION, Options1>, FFTCallSpec<DSTTYPE, SRCTYPE, DIRECTION, Options2>,     \
      ...
      FFTCallSpec<DSTTYPE, SRCTYPE, DIRECTION, Options5>, FFTCallSpec<DSTTYPE, SRCTYPE, DIRECTION, Options6>, \
      FFTCallSpec<DSTTYPE, SRCTYPE, DIRECTION, Options7>, FFTCallSpec<DSTTYPE, SRCTYPE, DIRECTION, Options8>

#define GENERATE_TESTING_TYPES_OPT1TO4(DSTTYPE, SRCTYPE, DIRECTION)                                       \
  FFTCallSpec<DSTTYPE, SRCTYPE, DIRECTION, Options1>, FFTCallSpec<DSTTYPE, SRCTYPE, DIRECTION, Options2>, \
      FFTCallSpec<DSTTYPE, SRCTYPE, DIRECTION, Options3>, FFTCallSpec<DSTTYPE, SRCTYPE, DIRECTION, Options4>

#define GENERATE_TESTING_TYPES_OPT5TO8(DSTTYPE, SRCTYPE, DIRECTION)                                       \
  FFTCallSpec<DSTTYPE, SRCTYPE, DIRECTION, Options5>, FFTCallSpec<DSTTYPE, SRCTYPE, DIRECTION, Options6>, \
      FFTCallSpec<DSTTYPE, SRCTYPE, DIRECTION, Options7>, FFTCallSpec<DSTTYPE, SRCTYPE, DIRECTION, Options8>
...
#define GENERATE_TESTING_TYPES_ALL_OPTIONS_R2C(DSTTYPE, SRCTYPE, HALFSPECTRUM_DSTTYPE) \
  GENERATE_TESTING_TYPES_OPT1TO4(DSTTYPE, SRCTYPE, true),                              \
      GENERATE_TESTING_TYPES_OPT5TO8(HALFSPECTRUM_DSTTYPE, SRCTYPE, true)

#define GENERATE_TESTING_TYPES_ALL_OPTIONS_C2R(DSTTYPE, SRCTYPE, HALFSPECTRUM_SRCTYPE) \
  GENERATE_TESTING_TYPES_OPT1TO4(DSTTYPE, SRCTYPE, false),                             \
      GENERATE_TESTING_TYPES_OPT5TO8(DSTTYPE, HALFSPECTRUM_SRCTYPE, false)
